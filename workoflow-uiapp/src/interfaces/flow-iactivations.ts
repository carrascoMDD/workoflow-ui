...
export interface IActivable extends ITyped {
    isActive: boolean;
...
export interface IApplicationActivation extends IActivable {
...
export interface IIdentityActivation extends IActivable {

    applicationActivation: IApplicationActivation;
    identityKey: string;

    getLogin(): string;

    copyIntoApplicationActivation( theApplicationActivation: IApplicationActivation);
