...
var InboxPage = /** @class */ (function () {
    function InboxPage(alertCtrl, app, loadingCtrl, modalCtrl, navCtrl, toastCtrl, user) {
    ...
    InboxPage.prototype.updateSchedule = function () {
    ...
    InboxPage.prototype.presentFilter = function () {
        var _this = this;
    ...
    InboxPage.prototype.goToSessionDetail = function (sessionData) {
        // go to the session detail page
        // and pass in the session data
        this.navCtrl.push(session_detail_1.SessionDetailPage, { sessionId: sessionData.id, name: sessionData.name });
    };
    InboxPage.prototype.openSocial = function (network, fab) {
    ...
    ], InboxPage.prototype, "scheduleList", void 0);
