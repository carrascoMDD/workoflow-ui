...
var DraftsPage = /** @class */ (function () {
    function DraftsPage(alertCtrl, app, loadingCtrl, modalCtrl, navCtrl, toastCtrl, user) {
    ...
    DraftsPage.prototype.updateSchedule = function () {
    ...
    DraftsPage.prototype.presentFilter = function () {
        var _this = this;
    ...
    DraftsPage.prototype.goToSessionDetail = function (sessionData) {
        // go to the session detail page
        // and pass in the session data
        this.navCtrl.push(session_detail_1.SessionDetailPage, { sessionId: sessionData.id, name: sessionData.name });
    };
    DraftsPage.prototype.openSocial = function (network, fab) {
    ...
    DraftsPage.prototype.doRefresh = function (refresher) {
        if (refresher) { }
        /*
      this.confData.getTimeline(this.dayIndex, this.queryText, this.excludeTracks, this.segment).subscribe((data: any) => {
        this.shownSessions = data.shownSessions;
    ...
    ], DraftsPage.prototype, "scheduleList", void 0);
